...
public class Counter {
    ...
    the number of each emotion recorded. The methods simply increment or decrement the various counters
    when called upon. The counters are static, meaning any instance of this class share the same counters
     */
